...
def launch_setup(context, *args, **kwargs):
    ...
    kinematics_yaml = load_yaml(
        "abb_irb2600_20_165_moveit_config", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "abb_irb2600_20_165_moveit_config", "config/ompl_planning.yaml"
    )
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    moveit_simple_controllers_yaml = load_yaml(
        "abb_irb2600_20_165_moveit_config", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(
        get_package_share_directory("abb_irb2600_20_165_moveit_config"), "rviz"
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description="Name of the support package",
            choices=["abb_irb2600_20_165_moveit_config"],
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            choices=["abb_irb2600_20_165.srdf.xacro"],
        )
    )
